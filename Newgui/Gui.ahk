...
Gui,Add,Text, vactivetab x200 y0 w300 cf5c88e,
...
Gui,Font,s9
Gui,Add,Text, v1tab24 x200 yp+40 w250 cwhite,1.
Gui,Add,Text, v1tab25 xp yp+25 w250 cwhite,2.
Gui,Add,Text, v1tab26 xp yp+25 w250 cwhite,3.
Gui,Add,Text, v1tab27 xp yp+25 w250 cwhite,4.
Gui,Add,Text, v1tab28 xp yp+25 w250 cwhite,5.
Gui,Add,Text, v1tab29 xp yp+25 w250 cwhite,6.
Gui,Add,Text, v1tab30 xp yp+25 w250 cwhite,7.
Gui,Font,s15 Bold
Gui,Add,Text, v1tab31 x285 y280 cwhite,About
Gui,Font,s9
Gui,Add,Text, v1tab32 xp-95 yp+30 w250 cwhite +wrap,The development of this macro started on 04/10/2022,You are allowed to share this macro with other people but you aren't allowed to steal my code and claim it is yours, if you do want to borrow some code you must give proper credits and mention that it was developed by me, The main thing this macro is targeted towards is bee swarm simulator automation specifically for endgame players.`n`nThis macro was completely developed by Syspalk, if you do encounter bugs you are able to report them to me on discord [Syspalk#0955] or you can join my discord server and report it there.`n`nLicensed with a GNU LGPL v2.1 license.
Gui,Font,s12 Bold
Gui,Add,Link, v1tab33 xp yp+240,<a href="https://discord.gg/t572FnTqfs">Join Discord</a>
Gui,Add,Link, v1tab34 xp yp+20,<a href="https://github.com/Syspalkius/bssmacro">Goto Github</a>
...
Gui,Add,Text, v11tab1 x75 y50 cWhite,character speed
Gui,Add,Edit, v11tab2 x20 yp number w50
Gui,Add,UpDown, v11tab3 Range10-50, %haststatus%
Gui,Add,Groupbox, v11tab4 x20 yp+35 w390 h140 cwhite,Webhooks
Gui,Add,Text, v11tab5 x210 yp+35 cwhite,Events webhook
Gui,Add,Edit, v11tab6 w175 h20 x30 yp, %hookevent%
Gui,Add,Text, v11tab7 x210 yp+35 cwhite,Errors webhook
Gui,Add,Edit, v11tab8 w175 h20 x30 yp, %hookerror%
Gui,Add,Text, v11tab9 x210 yp+35 cwhite,Balloon warnings webhook
Gui,Add,Edit, v11tab10 w175 h20 x30 yp, %hookballoon%
Gui,Add,Groupbox, v11tab11 x20 yp+50 w250 h130 cwhite,Vip Links
Gui,Add,Text, v11tab12 x160 yp+35 cwhite,main viplink
Gui,Add,Edit, v11tab13 w120 h20 x35 yp-5 ,%plink1%
Gui,Add,Text, v11tab14 x160 yp+35 cwhite,backup viplink
Gui,Add,Edit, v11tab15 w120 h20 x35 yp-5, %plink2%
Gui,Add,Checkbox, v11tab16 x30 yp+35 cwhite %serverdata%,Force join main link
Gui,Add,Groupbox, v11tab17 x20 yp+50 w250 h100 cwhite,Server Rebooter
Gui,Add,Checkbox, v11tab18 x30 yp+30 cwhite %resetserverdata%,Reboot the server
Gui,Add,Edit, v11tab19 x30 yp+30 number w50
Gui,Add,UpDown, v11tab20 Range10-5000, %servreboottime%
Gui,Add,Text, v11tab21 yp+2 x85 cwhite,Cooldown [Minutes]
Gui,Font,s12 Bold
Gui,Add,Text, v11tab22 x20 yp+50 c53ede5,Reset Config
Gui,Add,Text, v11tab23 x20 yp+25 c53ede5,Reset Timers
