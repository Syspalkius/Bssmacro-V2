...
Gui,Font,s9
Gui,Add,Text, v1tab12 x200 yp+40 w250 cwhite,1.
Gui,Add,Text, v1tab13 xp yp+25 w250 cwhite,2.
Gui,Add,Text, v1tab14 xp yp+25 w250 cwhite,3.
Gui,Add,Text, v1tab15 xp yp+25 w250 cwhite,4.
Gui,Add,Text, v1tab16 xp yp+25 w250 cwhite,5.
Gui,Add,Text, v1tab17 xp yp+25 w250 cwhite,6.
Gui,Add,Text, v1tab18 xp yp+25 w250 cwhite,7.
Gui,Font,s15 Bold
Gui,Add,Text, v1tab19 x285 y280 cwhite,About
Gui,Font,s9
Gui,Add,Text, v1tab20 xp-95 yp+30 w250 cwhite +wrap,The development of this macro started on 04/10/2022,You are allowed to share this macro with other people but you aren't allowed to steal my code and claim it is yours, if you do want to borrow some code you must give proper credits and mention that it was developed by me, The main thing this macro is targeted towards is bee swarm simulator automation specifically for endgame players.`n`nThis macro was completely developed by Syspalk, if you do encounter bugs you are able to report them to me on discord [Syspalk#0955] or you can join my discord server and report it there.`n`nLicensed with a GNU LGPL v2.1 license.
Gui,Font,s12
Gui,Add,Text, gJoindiscord v1tab21 xp yp+240 cblue,Join Discord
Gui,Add,Text, ggotogithub v1tab22 xp yp+20 cblue,Goto Github
...
gui,Add,Checkbox, v4tab1 x20 y50 cwhite %clock%,Use wealthclock
gui,Add,Checkbox, v4tab2 x20 yp+20 cwhite %gluedisp%,Use glue dispensor
gui,Add,Checkbox, v4tab3 x20 yp+20 cwhite %strawdisp%,Use Strawberry dispensor
gui,Add,Checkbox, v4tab4 x20 yp+20 cwhite %bluedisp%,Use blueberry dispensor
gui,Add,Checkbox, v4tab5 x20 yp+20 cwhite %cocodisp%,Use coconut dispensor
gui,Add,Checkbox, v4tab6 x20 yp+20 cwhite %killtb%,Kill tunnelbear
gui,Add,Checkbox, v4tab7 x20 yp+20 cwhite %killkb%,Kill kingbeetle
Gui,Add,Groupbox, v4tab8 x20 yp+20 w300 h90 cwhite,ant
Gui,Add,Checkbox, v4tab9 xp+5 yp+20 cwhite %antsetting%, claim free ant pass
Gui,Add,Checkbox, v4tab10 xp yp+20 cwhite %antcheck%, use free pass to play ant
Gui,Add,Checkbox, v4tab11 xp yp+20 cwhite %buyplayant%, buy and use ant pass every
Gui,Add,DropDownlist, v4tab12 xp+215 yp w60 h200 ,%whenplayantdata%||30 min|1 hour|2 hours|4 hours
Gui,Add,Text, v4tab13 x115 yp+45 cwhite,mondo kill type
Gui,Add,DropDownlist, v4tab14 x20 yp-2  w90 h200,%mondokilldata%||No Kill|Blessing|Loot
Gui,Add,Groupbox, v4tab15 x20 yp+30 w300 h75 cwhite, kill vicious
...
Gui,Add,Groupbox, v4tab19 x20 yp+30 w180 h145 cwhite,mobs
